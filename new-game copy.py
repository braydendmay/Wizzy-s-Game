...
def spawn_objects(num):
    ...
    for _ in range(num):
        ...
        y = -random.randint(y_level, 200)
        objs.append(pygame.Rect(x, y, 10, 40))
    return objs
...
while running:
    ...
    if not game_over:
        ...
        for obj in falling_objects:
            obj.y += fall_speed + 1
            pygame.draw.rect(screen, ice, obj)
            # Check collision
        ...
        if score == 10: y_level = -10
        if score == 20: y_level = -10
        # Draw player
        pygame.draw.rect(screen, (102, 187, 106), player)
